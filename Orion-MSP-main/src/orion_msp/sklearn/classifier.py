...
class OrionMSPClassifier(ClassifierMixin, BaseEstimator):
    """Multi-Scale Sparse Attention for Tabular In-Context Learning (ORION-MSP) with scikit-learn interface.
    ...
    inference_config: Optional[InferenceConfig | Dict[str, Dict[str, Any]]] = None
        ...
        over the transformers in ORION-MSO (column-wise, multi-scale sparce row interactor, Perceiver-memory and in-context learning).
    ...
    model_ : OroenMSP
        The loaded model used for predictions.
